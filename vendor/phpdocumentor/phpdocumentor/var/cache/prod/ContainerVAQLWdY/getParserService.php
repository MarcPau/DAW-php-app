...
class getParserService extends phpDocumentor_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $b = \phpDocumentor\Reflection\DocBlockFactory::createInstance();

        $c = new \phpDocumentor\Reflection\Php\Factory\Method($b);

        $a->addStrategy(new \phpDocumentor\Reflection\Php\Factory\ConstructorPromotion($c, $b, new \PhpParser\PrettyPrinter\Standard()), 1100);
        $a->addStrategy(new \phpDocumentor\Reflection\Php\Factory\Noop(), -10000);
        $a->addStrategy(\phpDocumentor\Parser\FileFactory::createInstance($b, \phpDocumentor\Reflection\Php\NodesFactory::createInstance(), new RewindableGenerator(function () use ($container) {
