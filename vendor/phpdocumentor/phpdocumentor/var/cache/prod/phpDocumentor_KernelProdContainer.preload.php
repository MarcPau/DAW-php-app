...
(require __DIR__.'/phpDocumentor_KernelProdContainer.php')->set(\ContainerVAQLWdY\phpDocumentor_KernelProdContainer::class, null);
require __DIR__.'/ContainerVAQLWdY/getTactician_Commandbus_DefaultService.php';
require __DIR__.'/ContainerVAQLWdY/getServicesResetterService.php';
require __DIR__.'/ContainerVAQLWdY/getSecrets_VaultService.php';
require __DIR__.'/ContainerVAQLWdY/getRouting_LoaderService.php';
require __DIR__.'/ContainerVAQLWdY/getEnvironmentFactoryService.php';
require __DIR__.'/ContainerVAQLWdY/getPlantumlRendererService.php';
require __DIR__.'/ContainerVAQLWdY/getRouter2Service.php';
require __DIR__.'/ContainerVAQLWdY/getParseFileHandlerService.php';
require __DIR__.'/ContainerVAQLWdY/getParseDirectoryHandlerService.php';
require __DIR__.'/ContainerVAQLWdY/getRendererService.php';
require __DIR__.'/ContainerVAQLWdY/getRenderHandlerService.php';
require __DIR__.'/ContainerVAQLWdY/getPersistCacheHandlerService.php';
require __DIR__.'/ContainerVAQLWdY/getLoadCacheHandlerService.php';
require __DIR__.'/ContainerVAQLWdY/getMonolog_Logger_CacheService.php';
require __DIR__.'/ContainerVAQLWdY/getMonolog_LoggerService.php';
require __DIR__.'/ContainerVAQLWdY/getErrorControllerService.php';
require __DIR__.'/ContainerVAQLWdY/getContainer_GetenvService.php';
require __DIR__.'/ContainerVAQLWdY/getContainer_EnvVarProcessorsLocatorService.php';
require __DIR__.'/ContainerVAQLWdY/getContainer_EnvVarProcessorService.php';
require __DIR__.'/ContainerVAQLWdY/getCache_SystemClearerService.php';
require __DIR__.'/ContainerVAQLWdY/getCache_SystemService.php';
require __DIR__.'/ContainerVAQLWdY/getCache_GlobalClearerService.php';
require __DIR__.'/ContainerVAQLWdY/getCache_AppClearerService.php';
require __DIR__.'/ContainerVAQLWdY/getCache_AppService.php';
require __DIR__.'/ContainerVAQLWdY/getArgumentResolver_ServiceService.php';
require __DIR__.'/ContainerVAQLWdY/getTemplateControllerService.php';
require __DIR__.'/ContainerVAQLWdY/getRedirectControllerService.php';
require __DIR__.'/ContainerVAQLWdY/get_ServiceLocator_U47of_0Service.php';
require __DIR__.'/ContainerVAQLWdY/get_ServiceLocator_KfbR3DYService.php';
require __DIR__.'/ContainerVAQLWdY/get_Container_Private_FilesystemService.php';
require __DIR__.'/ContainerVAQLWdY/get_Container_Private_CacheClearerService.php';
