...
class Principal {
     ...
     * </p>
     * <ul>
     *     <li>Obtiene la conexión a la base de datos utilizando la clase {@link Connexio}.</li>
     *     <li>Ejecuta una consulta SQL para recuperar la lista de productos, incluyendo información de categorías.</li>
     *     <li>Genera una tabla HTML para mostrar los productos.</li>
     *     <li>Incluye opciones de acciones como "Modificar" y "Eliminar" para cada producto.</li>
     *     <li>Proporciona un botón para agregar un nuevo producto.</li>
     * </ul>
     *
     * @return void
     * 
     * @throws Exception Si ocurre un error al conectarse a la base de datos o al ejecutar la consulta.
     */
